---
title: "Estado del COVID-19 en Costa Rica (Kevin Chavarría)"
output: 
...
icono_fallecidos <- 'fas fa-users-slash'

icono_nuevos_positivos <- 'fas fa-user-check'

icono_hospitalizados <- 'fas fa-user-injured'
icono_salon <- 'fas fa-hospital-user'
icono_uci <- 'fas fa-user-ambulance'
